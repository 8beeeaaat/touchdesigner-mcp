...
- Five places in the OpenAPI schema hung keywords off a `$ref`, which OpenAPI 3.0 discards. Three of them dropped a `nullable: true`, so the schema promised a field could be null and a strict reader was told the opposite. All five now wrap the reference in `allOf`; the generated client is byte-identical ([#228](https://github.com/8beeeaaat/touchdesigner-mcp/issues/228)).
