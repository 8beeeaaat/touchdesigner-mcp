...
export class SessionManager implements ISessionManager {
	...
	/**
	 * Register an existing session (e.g., created by SDK)
	 *
	 * This method is used to track sessions that were created by the MCP SDK's
	 * StreamableHTTPServerTransport. The SDK generates session IDs via the
	 * onsessioninitialized callback, and this method registers them for tracking.
	 *
